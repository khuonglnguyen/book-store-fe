...
function OrderBook({setHide}) {
    return (
        <OrderPanel>
			<div className="blur">
				<div className="orderform-container">
					<form id="orderform-form">
						<h2>Order orderform</h2>
						...
						<div className="form-group">
							...
							<div className="contentInput">
								...
								<input className="totalPrice" type="text" id="text" name="text"/>
							</div>
						</div>
						...
						<div className="form-group">
							...
							<input type="text" id="text" name="text" placeholder="Enter your address" required/>
						</div>

						<div className="form-group">
							<label for="">Description</label>
							<textarea placeholder="Enter a description of the orderform" required/>
						</div>
