			...
			<div className="blur" >
				<div className="category-container">
					<form id="category-form">
						<h2>Add New Category 's Information</h2>

						<div className="form-group" >
							<label for="text">Category</label>
							<input type="text" id="text" name="text" placeholder="Enter name of category" required />
						</div>

						<div className="form-group">
							<label for="text">Description</label>
							<textarea placeholder="Enter a description of the category" required />
						</div>
